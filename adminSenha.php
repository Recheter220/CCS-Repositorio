		...
		if ($_POST["acao"] == "Senha") {
			...
			if (empty($erros)) {
				foreach(array_keys($_POST) as $chave) {
					$_SESSION["inst"][$chave] = $_POST[$chave];
				}
		...
		<form class="form-center" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
			<div class="form-container">
				...
				<div class="form-group">
					<label for="instSenha"> Senha atual </label>
					<input type="password" class="form-control" name="senhaAtual" id="instSenha" required="required" />
				</div>
				<div class="form-group">
					<label for="instSenha"> Nova senha </label>
					<input type="password" class="form-control" name="senha" id="instSenha" required="required" />
				</div>
				<div class="form-group">
					<label for="instSenha2"> Confirmar nova senha </label>
					<input type="password" class="form-control" name="senha2" id="instSenha2" required="required" />
				</div>
