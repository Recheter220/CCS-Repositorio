		...
		<form class="form-center" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
			<div class="form-container">
				...
				<div class="form-group">
					<label for="profSenha"> Senha atual </label>
					<input type="password" class="form-control" name="senhaAtual" id="profSenha" required="required" />
				</div>
				<div class="form-group">
					<label for="profSenha"> Nova senha </label>
					<input type="password" class="form-control" name="senha" id="profSenha" required="required" />
				</div>
				<div class="form-group">
					<label for="profSenha2"> Confirmar nova senha </label>
